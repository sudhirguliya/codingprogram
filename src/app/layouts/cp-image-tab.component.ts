...
@Component({
  moduleId: module.id,
  selector: 'image-tab-show',
  //template : 'test menu'
  template: `<div class="image">
                <img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="{{this.src}}" alt="{{cpImage.page_name}}" />
                <div class="overlay-box">
                  <div class="content">
                      <div class="tag"><a [routerLink]="this.subcategory ? ['/', this.category, this.subcategory] : ['/', this.category]">{{cpImage.details.category_detail.category_name}}</a></div>
...
export class CpImageTabComponent {
