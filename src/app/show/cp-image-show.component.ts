...
@Component({
  ...
  template: `<div class="image">
                <a [routerLink]="this.subcategory ? ['/', this.category, this.subcategory, 'post', cpImage.page_name] : ['/', this.category, 'post', cpImage.page_name]"><img class="wow fadeIn" data-wow-delay="0ms" data-wow-duration="2500ms" src="{{this.src}}" alt="{{cpImage.page_name}}" /></a>
            ...
            <div class="lower-box">
              <h3><a [routerLink]="this.subcategory ? ['/', this.category, this.subcategory, 'post', cpImage.page_name] : ['/', this.category, 'post', cpImage.page_name]">{{cpImage.page_title | truncate : 64 : true }}</a></h3>
              <!-- <ul class="post-meta">
              ...
              <!-- [innerText]="cpImage.page_description " -->
              <!-- [innerHTML]="cpImage.page_description | keepHtml" --> 
              <div class="text" >{{cpImage.page_description | removeHtml | truncate : 200 : true}}
              </div>
            </div>`,
...
export class CpImageShowComponent {
